...
// Generates a partial match table from the string in which we will be
// searching.
//
// Args:
//   - search: string, the text which the table is generated from.
// 
// Returns:
//   vector<int>: the match table generated from our search string.
//
